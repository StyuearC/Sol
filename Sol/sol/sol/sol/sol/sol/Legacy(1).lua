...
Fluent:RegisterCustomTheme("Vintage", {
    Accent              = Color3.fromRGB(255, 185, 40),
    AcrylicMain         = Color3.fromRGB(12, 8, 3),
    AcrylicBorder       = Color3.fromRGB(160, 100, 20),
    AcrylicGradient     = ColorSequence.new(Color3.fromRGB(12, 8, 3), Color3.fromRGB(30, 15, 0)),
    AcrylicNoise        = 0.85,
    TitleBarLine        = Color3.fromRGB(200, 130, 20),
    Tab                 = Color3.fromRGB(50, 30, 5),
    Element             = Color3.fromRGB(40, 25, 5),
    ElementBorder       = Color3.fromRGB(160, 100, 20),
    InElementBorder     = Color3.fromRGB(220, 150, 30),
    ElementTransparency = 0.82,
    ToggleSlider        = Color3.fromRGB(255, 185, 40),
    ToggleToggled       = Color3.fromRGB(25, 15, 0),
    SliderRail          = Color3.fromRGB(160, 100, 20),
    DropdownFrame       = Color3.fromRGB(255, 255, 255),
    DropdownHolder      = Color3.fromRGB(20, 12, 2),
    DropdownBorder      = Color3.fromRGB(160, 100, 20),
    DropdownOption      = Color3.fromRGB(255, 185, 40),
    Keybind             = Color3.fromRGB(120, 75, 15),
    Input               = Color3.fromRGB(255, 255, 255),
    InputFocused        = Color3.fromRGB(30, 18, 3),
    InputIndicator      = Color3.fromRGB(220, 160, 30),
    Dialog              = Color3.fromRGB(18, 11, 2),
    DialogHolder        = Color3.fromRGB(12, 7, 1),
    DialogHolderLine    = Color3.fromRGB(8, 5, 1),
    DialogButton        = Color3.fromRGB(22, 14, 3),
    DialogButtonBorder  = Color3.fromRGB(180, 115, 20),
    DialogBorder        = Color3.fromRGB(160, 100, 20),
    DialogInput         = Color3.fromRGB(22, 14, 3),
    DialogInputLine     = Color3.fromRGB(220, 160, 30),
    Text                = Color3.fromRGB(255, 240, 195),
    SubText             = Color3.fromRGB(220, 185, 120),
    Hover               = Color3.fromRGB(100, 60, 10),
    HoverChange         = 0.06,
    ShineEnabled        = true,
    Shine               = {
        Speed = 0.4,
        RotationSpeed = 18,
        ColorSequence = ColorSequence.new({
            ColorSequenceKeypoint.new(0,   Color3.fromRGB(120, 70, 5)),
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 185, 40)),
            ColorSequenceKeypoint.new(1,   Color3.fromRGB(120, 70, 5)),
        }),
    },
    StrokeShine         = true,
    StrokeDark          = Color3.fromRGB(100, 65, 10),
    ButtonGradient      = {
        Background = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(160, 100, 15)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(50, 30, 5)),
        }),
        Stroke = ColorSequence.new({
            ColorSequenceKeypoint.new(0,   Color3.fromRGB(255, 185, 40)),
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 215, 80)),
            ColorSequenceKeypoint.new(1,   Color3.fromRGB(255, 185, 40)),
        }),
    },
})

Fluent:RegisterCustomTheme("Legacy", {
    Accent              = Color3.fromRGB(80, 220, 255),
    AcrylicMain         = Color3.fromRGB(5, 5, 18),
    AcrylicBorder       = Color3.fromRGB(40, 140, 200),
    AcrylicGradient     = ColorSequence.new(Color3.fromRGB(5, 5, 18), Color3.fromRGB(10, 20, 50)),
    AcrylicNoise        = 0.8,
    TitleBarLine        = Color3.fromRGB(60, 180, 240),
    Tab                 = Color3.fromRGB(15, 40, 80),
    Element             = Color3.fromRGB(10, 30, 65),
    ElementBorder       = Color3.fromRGB(40, 140, 200),
    InElementBorder     = Color3.fromRGB(70, 190, 245),
    ElementTransparency = 0.82,
    ToggleSlider        = Color3.fromRGB(80, 220, 255),
    ToggleToggled       = Color3.fromRGB(5, 15, 35),
    SliderRail          = Color3.fromRGB(40, 140, 200),
    DropdownFrame       = Color3.fromRGB(255, 255, 255),
    DropdownHolder      = Color3.fromRGB(5, 15, 40),
    DropdownBorder      = Color3.fromRGB(40, 140, 200),
    DropdownOption      = Color3.fromRGB(80, 220, 255),
    Keybind             = Color3.fromRGB(30, 100, 160),
    Input               = Color3.fromRGB(255, 255, 255),
    InputFocused        = Color3.fromRGB(8, 20, 50),
    InputIndicator      = Color3.fromRGB(60, 190, 240),
    Dialog              = Color3.fromRGB(5, 12, 32),
    DialogHolder        = Color3.fromRGB(3, 8, 22),
    DialogHolderLine    = Color3.fromRGB(2, 5, 15),
    DialogButton        = Color3.fromRGB(6, 14, 36),
    DialogButtonBorder  = Color3.fromRGB(50, 155, 215),
    DialogBorder        = Color3.fromRGB(40, 140, 200),
    DialogInput         = Color3.fromRGB(6, 14, 36),
    DialogInputLine     = Color3.fromRGB(60, 190, 240),
    Text                = Color3.fromRGB(215, 245, 255),
    SubText             = Color3.fromRGB(140, 205, 240),
    Hover               = Color3.fromRGB(20, 90, 160),
    HoverChange         = 0.06,
    ShineEnabled        = true,
    Shine               = {
        Speed = 0.5,
        RotationSpeed = 24,
        ColorSequence = ColorSequence.new({
            ColorSequenceKeypoint.new(0,   Color3.fromRGB(10, 60, 130)),
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(80, 220, 255)),
            ColorSequenceKeypoint.new(1,   Color3.fromRGB(10, 60, 130)),
        }),
    },
    StrokeShine         = true,
    StrokeDark          = Color3.fromRGB(20, 90, 160),
    ButtonGradient      = {
        Background = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(20, 100, 180)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(5, 25, 70)),
        }),
        Stroke = ColorSequence.new({
            ColorSequenceKeypoint.new(0,   Color3.fromRGB(50, 180, 240)),
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(100, 235, 255)),
            ColorSequenceKeypoint.new(1,   Color3.fromRGB(50, 180, 240)),
        }),
    },
})
...
if _G.SolasmotaryXIsAlreadyRunning then
    ...
    _rtl2.TextColor3 = Color3.fromRGB(160, 180, 210)
    ...
    _forceBtn.BackgroundColor3 = Color3.fromRGB(0, 130, 215)
    ...
    _cancelBtn.BackgroundColor3 = Color3.fromRGB(55, 20, 20)
...
local function _applyBtnTrans(buttonName, raw)
    ...
    -- Apply directly to the named button's frame
...
function DFunctions.CreateTimer()
    if LocalPlayer.PlayerGui:FindFirstChild("TimerGui_Legacy") then return end

    -- Warna accent dari ButtonGradients
    local accentA = Color3.fromRGB(0, 160, 255)
    local accentB = Color3.fromRGB(0,  20,  60)
    if getgenv and getgenv().ButtonGradients then
        ...
        if ok and ks and ks[1] then
            accentA = ks[1].Value
            accentB = ks[#ks] and ks[#ks].Value or accentA
        end
    end

    local sg = Instance.new("ScreenGui")
    sg.Name           = "TimerGui_Legacy"
    ...
    _timerBgAnim = RunService.RenderStepped:Connect(function(dt)
        ...
        -- sync warna dari ButtonGradients
        if getgenv and getgenv().ButtonGradients then
            local ok, ks = pcall(function() return getgenv().ButtonGradients.Stroke.Keypoints end)
            if ok and ks and ks[1] then
                local a = ks[1].Value
    ...
    local function hookStats()
        ...
        local function refresh()
            ...
            countdownLbl.Text       = _fmtTime(t)
            countdownLbl.TextColor3 = (t and t <= 5) and Color3.fromRGB(255, 80, 80) or Color3.fromRGB(255, 255, 255)
...
-- Show Timer (menggunakan floating GUI baru yang mengikuti warna theme)
...
do
    local PlatData = { Enabled = false, Size = 12, Transparency = 0.5, List = {} }
    ...
    local function GetCactusFolder()
        ...
        for _, obj in pairs(folder:GetChildren()) do
            if obj.Name == "Cactus1" or obj.Name == "Cactus2" then
                ...
                if pos and size then
                    ...
                    plate.Name        = "Legacy_CactusPlate"
                    plate.Size        = Vector3.new(PlatData.Size, 1, PlatData.Size)
                    plate.Anchored    = true
                    plate.CanCollide  = true
                    plate.Material    = Enum.Material.Neon
                    plate.Transparency = PlatData.Transparency
                    plate.Color       = Color3.fromRGB(0, 180, 255) -- Azure tint untuk Legacy
                    plate.Position    = pos + Vector3.new(0, (size.Y / 2) + 0.5, 0)
                    plate.Parent      = workspace
                    table.insert(PlatData.List, plate)
                end
            end
        end
    end

    Tabs.Movement:AddSection("Cactus Platform")
    ...
    Tabs.Movement:AddInput("CactusTransInput", {
    ...
    Tabs.Movement:AddInput("CactusSizeInput", {
        Title    = "Platform Size",
        Default  = "12",
        Numeric  = true,
        Finished = true,
    ...
    -- Auto-refresh setiap 3 detik jika map berganti
    task.spawn(function()
